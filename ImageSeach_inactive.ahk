...
ImageSearch_Inactive(Title, ImgFileName)
{
	...
	; pBitmapHayStack := Gdip_CreateBitmapFromFile("AllCalc.bmp")
	msgbox % WinExist(Title)
	
	pBitmapHayStack := Gdip_BitmapFromHWND(WinExist(Title)) 
	...
	Gdip_ImageSearch( Scan01, Scan02, Width1, Height1, Width2, Height2, Stride1, Stride2, x, y)
	MsgBox, % "x: " x "`ny: " y ;%
...
F9::
	ImageSearch_Inactive("제목 없음","notepad.bmp")
	return
