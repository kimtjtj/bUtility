; ref : https://github.com/arusia88/arusMacro

GetCurrentPosition_ActiveWindow(ByRef x, ByRef y)
{
	WinGetPos, findSelfX, findSelfY, findSelfWidth, findSelfHeight, A
	...
	x := (X100*100)+(X10*10)+(X1)
	y := (Y100*100)+(Y10*10)+(Y1)
